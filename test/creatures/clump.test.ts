 ...
 *   root is scaled up.
 */
/* The packing describe that stood here was the interim model (items packed
 * against the creature). Restored 2026-09-18 to the original: the items are
 * seated on the BALL's surface, which is the creature's own body grown. */
