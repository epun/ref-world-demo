 ...
 * through `mapScale` (2026-09-16) — 244.2 at scale 1.32, which holds that
 * coast's measured 232.66 with the 17.5 units of breathing room the 185 above
 * holds over 176.26, scaled: both numbers ride the same factor. A map
