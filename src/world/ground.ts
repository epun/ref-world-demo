 ...
 *          528×528 at the same 1.25-unit resolution on a `MAP_SCALE` 1.32
 *          island (src/world/field.ts): the side rides `mapScale` and so does
 *          the segment count, rounded — so the QUAD moves by half a segment
 *          (1.25118) and not with the map.
 *   far    a flat ring from the field's rim out to 1400 — 1848 on the island,
 ...
 * looks at. The terrain is exactly 0 past `farFieldEnd` (185, and 244.2 on a
